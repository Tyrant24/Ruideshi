        ...
        <div class="loginbox flex-row">
          <div class="margin">
            ...
            <div v-if="data.logintype == 0">
              ...
              <div class="tongyi margin-top-33">
                完成登录则代表同意瑞德仕账号<b
                  class="pointer"
                  @click="showContent"
                  >用户协议</b
                >和<b class="pointer" @click="showContent">隐私政策</b>
              </div>
              <div
                class="
                  bgorange
            ...
            <div v-if="data.logintype == 1">
              <div>
                <wxlogin
                  :href="page.domain + '/loginqrcode.css'"
                  class="qrcode margin-top-44"
                  v-if="page.Inst != null"
                  :appid="page.Inst.openwebsiteappid"
                  :scope="'snsapi_login'"
                  :redirect_uri="page.domain + '/wechatlogin'"
                  :state="data.vurl"
                ></wxlogin>
              </div>
              <div class="tongyi margin-top-33">
...
export default {
  ...
  methods: {
    ...
    vcodeclose() {},
    login() {
      HttpHelper.Post("member/mobilelogin", {
        mobile: this.mobile,
        ...
        if (ret.code == 0) {
          ...
          this.data.showPopover2 = true;
          this.data.popover2tips = ret.result;
        }
      });
    },
  },
