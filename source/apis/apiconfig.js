export class ApiConfig {
  ...
  // static GetApiUrl() {
  //   return "https://cmsdev.app-link.org/alucard263096/ruideshi/api/";
  // }
  // static GetUploadPath() {
  //   return "https://alioss.app-link.org/alucard263096/ruideshi/";
  // }
  // static GetFileUploadAPI() {
  //   return "https://cmsdev.app-link.org/alucard263096/ruideshi/fileupload";
  // }

  static GetApiUrl() {
    return "https://api.ritusmix.com/api/";
  }
  static GetUploadPath() {
    return "http://oss.ritusmix.com/";
  }
  static GetFileUploadAPI() {
    return "https://api.ritusmix.com/fileupload";
  }
